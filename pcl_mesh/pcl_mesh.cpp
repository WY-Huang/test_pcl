...
int main(int argc, char** argv)
{
	...
	if (pcl::io::loadPCDFile("/home/wanyel/vs_code/test_pcl/imgs/2022_12_02_13_04_21_396.pcd", *cloud) == -1)
    {
        cout << "点云数据读取失败！" << endl;
    }
    ...
    pcl::io::savePCDFile ("/home/wanyel/vs_code/test_pcl/imgs/downsampledPC.pcd", *cloud_downSampled);
    ...
    pcl::io::savePCDFile ("/home/wanyel/vs_code/test_pcl/imgs/filteredPC.pcd", *cloud_filtered);
    ...
    //save cloud_smoothed
    pcl::io::savePCDFileASCII("/home/wanyel/vs_code/test_pcl/imgs/cloud_smoothed.pcd",*cloud_smoothed);
    ...
    pcl::io::savePCDFileASCII("/home/wanyel/vs_code/test_pcl/imgs/normals.pcd",*normals);
	
	// 将点云位姿、颜色、法线信息连接到一起
    pcl::PointCloud<pcl::PointNormal>::Ptr cloud_with_normals(new pcl::PointCloud<pcl::PointNormal>);
    pcl::concatenateFields(*cloud_smoothed, *normals, *cloud_with_normals);
    pcl::io::savePCDFileASCII("/home/wanyel/vs_code/test_pcl/imgs/cloud_with_normals.pcd",*cloud_with_normals);
    ...
    // 保存网格图
    pcl::io::saveVTKFile("/home/wanyel/vs_code/test_pcl/imgs/mymesh.vtk",triangles);
    pcl::io::savePLYFile ("/home/wanyel/vs_code/test_pcl/imgs/test_ply.ply", triangles);
